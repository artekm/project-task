...
public class ScheduleGeneratorTest {
	...
	@Test
	public void generate_filtersOutHolidays_createsCorrectSchedule() {
		EnteredParameters parameters = new EnteredParameters();
		parameters.setBeginTime(LocalTime.of(9, 0));
		parameters.setEndTime(LocalTime.of(12, 0));
		parameters.setStartDate(LocalDate.of(2019, 12, 23));
		parameters.setHoursNumber(9);
		parameters.setLessonDays(Arrays.asList(MONDAY, WEDNESDAY));

		Lesson firstLesson = new Lesson(LocalDate.of(2019, 12, 23), LocalTime.of(9, 0), LocalTime.of(12, 0));
		Lesson secondLesson = new Lesson(LocalDate.of(2019, 12, 30), LocalTime.of(9, 0), LocalTime.of(12, 0));
		Lesson thirdLesson = new Lesson(LocalDate.of(2020, 1, 8), LocalTime.of(9, 0), LocalTime.of(12, 0));
	...
	private final static class HolidaysWebClientMock implements HolidaysProvider {
		...
		public Collection<LocalDate> getHolidays(LocalDate from, LocalDate to) {
			return Arrays.asList(LocalDate.of(2019, 12, 25), LocalDate.of(2020, 1, 1),
